...
<%
	...
	// 웹 URL로부터 전달 받는 값들(스프링은 기본적으로 포워드 방식으로 페이지를 이동하기 때문에 url에 입력받은 request 값을 가져올 수 있음, 일반적인 jsp에선 불가능함)
	String toMail = CmmUtil.nvl((String)request.getParameter("toMail")); // 받는 사람
	String title = CmmUtil.nvl((String)request.getParameter("title")); // 제목
	String contents = CmmUtil.nvl((String)request.getParameter("contents")); // 내용
%>
<!DOCTYPE html>
<html>
<head>
