...
public class MailService implements IMailService {
	...
	final String host = "smtp.naver.com"; //네이버에서 제공하는 SMTP 서버
<<<<<<< HEAD
	final String user = "polytech_data16@naver.com"; // 본인 네이버 아이디
	final String password = "vhfflxpr"; // 본인 네이버 비밀번호
=======
	//final String user = ""; // 본인 네이버 아이디
	//final String password = ""; // 본인 네이버 비밀번호
>>>>>>> branch 'master' of https://github.com/senor14/SpringStudy
	...
	public int doSendMail(MailDTO pDTO) {
		...
		log.info("메일주소:"+pDTO.getToMail());
		log.info("메일제목:"+pDTO.getTitle());
		log.info("메일내용:"+pDTO.getContents());
